...
* @{
*/
#define PRODUCT_KEY "d501bb31f7844dafb8641a9a84cd763d"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "d8c8b6777f434a30b6db85cc7a7fd68f"
...
#define Water_BITOFFSET                     0
#define Water_LEN                           1
#define Fan_BYTEOFFSET                    0
#define Fan_BITOFFSET                     1
#define Fan_LEN                           1
#define All_BYTEOFFSET                    0
#define All_BITOFFSET                     2
#define All_LEN                           1
#define Voice_BYTEOFFSET                    0
#define Voice_BITOFFSET                     3
#define Voice_LEN                           1
#define LED_BYTEOFFSET                    0
#define LED_BITOFFSET                     4
#define LED_LEN                           2
